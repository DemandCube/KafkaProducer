...
public class TestKafkaWriter {
	...
	/**
	 * Write to kafka, write to buffer. Read from kafka, read from buffer.
	 * Should be equal.
	 */
	@Test
   ...
   */
	...
	public void testWriteManyPartitions() throws Exception {
		...
		System.out.println("expectedSize: " + expected.size() + " actualSize:"
				+ actual.size());
	...
	/**
	 * Write 100 messages to a non existent topic. If Exception thrown then we
	 * are good.
	 */
	@Test
	...
	/**
	 * Write 2000 messages to kafka, count number of messages read. They should
	 * be equal
	 */
	@Test
	...
	/**
	 * Start 6 writers to same topic/partition. Run them for a while, read from
	 * topic and partition.
	 * 
	 * @throws Exception
	 */
